...
public class TomorrowAdapter_Meetroom extends BaseAdapter {
    ...
    //构造方法
    public TomorrowAdapter_Meetroom(Context context , List<MeetRoom.MsgEntity> datas){
        this.datas = datas;
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        final TomorrowAdapter_Meetroom.ViewHolder viewHolder;
        if(view==null){
...
//                Toast.makeText(context, "哈哈哈哈", Toast.LENGTH_SHORT).show();
    ...
    private class ViewHolder{
        ...
        public ViewHolder(View view){
            ...
            //初始化item隐藏布局item2
            item2=(LinearLayout) view.findViewById(R.id.item2_meetroomtomorrow);
            //初始化显示布局
            item1=(RelativeLayout)view.findViewById(R.id.item1_meetroomtomorrow);
