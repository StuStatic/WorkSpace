...
public class OtherdateAdapter_Meetroom extends BaseAdapter {
    ...
    //构造方法
    public OtherdateAdapter_Meetroom(Context context , List<MeetRoom.MsgBean> datas){
        this.datas = datas;
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        final OtherdateAdapter_Meetroom.ViewHolder viewHolder;
        if(view==null){
...
//                Toast.makeText(context, "哈哈哈哈", Toast.LENGTH_SHORT).show();
    ...
    private class ViewHolder{
        ...
        public ViewHolder(View view){
            //初始化TextView
            tv_floor=(TextView)view.findViewById(R.id.meetroom_floor_otherday);
            tv_address=(TextView)view.findViewById(R.id.meetroom_address_otherday);
            tv_peoplenum=(TextView)view.findViewById(R.id.meetroom_peoplenum_otherday);
            tv_price=(TextView)view.findViewById(R.id.meetroom_price_otherday);
            //初始化ImageView
            img=(ImageView)view.findViewById(R.id.meetroom_img_otherday);
            //明面上的订购按钮
            img_order_show=(ImageView)view.findViewById(R.id.meetroom_order_show);
            //初始化item隐藏布局item2
            item2=(LinearLayout) view.findViewById(R.id.item2_meetroomotherday);
            //初始化显示布局
            item1=(RelativeLayout)view.findViewById(R.id.item1_meetroomotherday);
