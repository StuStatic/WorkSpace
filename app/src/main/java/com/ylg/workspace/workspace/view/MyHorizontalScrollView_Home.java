...
public class MyHorizontalScrollView_Home extends HorizontalScrollView implements View.OnClickListener {
    /**
     * 图片滚动时的回调接口
     *
     * @author stu
    ...
    public MyHorizontalScrollView_Home(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        // 获得屏幕宽度
